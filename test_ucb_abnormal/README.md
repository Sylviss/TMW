# UCB Abnormal (PTB-DB) GAN Training

This notebook trains and evaluates a GAN on PTB-DB abnormal ECG data using
...
2. In the **CONFIGURATION** cell, update:
   - `TRAIN_CONFIG["data_path"]` (default: `../consolidated_datasets/pcb/ptbdb_abnormal.csv`)
...
TRAIN_CONFIG = {
   ...
   "data_path": "../consolidated_datasets/pcb/ptbdb_abnormal.csv",
   "output_dir": ".",
}
```
